...
<div class="contenedor">
    ...
    <img src="https://static.vecteezy.com/system/resources/previews/026/631/445/non_2x/add-photo-icon-symbol-design-illustration-vector.jpg">
</button>
...
<script>
    function modificar(){
        window.open("modificarvehiculo.php");
    }
    function cancelar(){
        window.open("vehiculosrregistrados.php");
    }
    function vehiculo(){
